...
class PersistentLottieTabsPage extends GetView<PersistentLottieTabsController> {
  const PersistentLottieTabsPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetBuilder<PersistentLottieTabsController>(
        builder: (_) {
